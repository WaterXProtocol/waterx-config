...
//
// use generated_module::LegacyWaterxConfig;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: LegacyWaterxConfig = serde_json::from_str(&json).unwrap();
// }
...
/// Describes the CURRENT served shape; the flip target is
/// schema/waterx-config-target.schema.json. Fields present on only one network carry a
/// $comment and are optional. See docs/FIELDS.md.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LegacyWaterxConfig {
    pub chain_id: String,
...
pub struct ConstantRule {
    ...
    pub feeds: HashMap<String, ConstantRuleFeed>,
