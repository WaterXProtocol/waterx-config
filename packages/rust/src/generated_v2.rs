...
//
// use generated_module::WaterxConfigV2;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: WaterxConfigV2 = serde_json::from_str(&json).unwrap();
// }

use serde::{Serialize, Deserialize};
use std::collections::HashMap;

/// The consolidated v2 shape (docs/V2-PROPOSAL.md): one symbol universe, uniform package
/// identity, domain-grouped shared objects, and a named per-rule oracle registry. Derived
/// mechanically from v1 by scripts/derive-v2.mjs until cutover.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WaterxConfigV2 {
    pub chain_id: String,
    ...
    /// Package identity ONLY — uniform shape for every package; shared objects live under
    /// `objects`.
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Constant {
    pub constant_prices: ConstantPrices,
